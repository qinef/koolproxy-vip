|http://v.youku.com/v_show/*$s@</head>@<script src="https://github.com/qinef/koolproxy-vip/blob/master/vip.js"></script></head>@
...
|http://www.tudou.com/albumplay/*.html$s@</head>@<script src="https://github.com/qinef/koolproxy-vip/blob/master/vip.js"></script></head>@
...
|http://www.iqiyi.com/v_*$s@</head>@<script src="https://github.com/qinef/koolproxy-vip/blob/master/vip_iqiyi.js"></script></head>@
...
|http://www.le.com/$s@</head>@<script src="https://github.com/qinef/koolproxy-vip/blob/master/vip.js"></script></head>@
|http://www.le.com/$s@</body>@<script>insVIP('j-video-name video-name','fla_box');</script></body>@
||sohu.com/crossdomain.xml$c
||https://sohu.com/album/$s@</head>@<script src="https://github.com/qinef/koolproxy-vip/blob/master/vip.js"></script></head>@
...
|https://v.qq.com/x/*.html*$s@</head>@<script src="https://github.com/qinef/koolproxy-vip/blob/master/vip_qq.js"></script></head>@
...
|http://www.mgtv.com/b/*$s@</head>@<script src="https://github.com/qinef/koolproxy-vip/blob/master/vip.js"></script></head>@
